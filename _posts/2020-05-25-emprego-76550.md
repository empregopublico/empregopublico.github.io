...
Descricao: No âmbito das competências previstas na estrutura nuclear ou flexível da Câmara Municipal de Leiria para a correspondente unidade orgânica, em função da sua área de atividade (Pintor)  a) Exerce funções de natureza executiva, de carácter manual ou mecânico, enquadradas em diretivas gerais bem definidas e com graus de complexidade variáveis  b) Executa tarefas de apoio elementares, indispensáveis ao funcionamento dos órgãos e serviços, podendo comportar esforço físico  c) É responsável pelos equipamentos sob a sua guarda e pela sua correta utilização, procedendo, quando necessário, à manutenção e reparação dos mesmos. Manutenção, reparação e pintura de edifícios municipais e apoio a eventos 
